    ...
    function ({ addBase, addUtilities }) {
      addBase({
        ...
        ':root, [data-theme="light"]': {
          ...
          /* Strokes are hairlines, not the 2px ink outline the design started
             with: at this component density a black rule around every card,
             input and panel read as a wireframe. --stroke stays a single knob,
             so it still drives every border in the app. */
          "--stroke": "#DFD9CB",
