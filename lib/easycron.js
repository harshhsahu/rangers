 ...
 */
export async function addCronJob({ url, cronExpression, timezone, name, description }) {
...
export async function editCronJob(cronJobId, { url, cronExpression, timezone, name } = {}) {
  await call("edit", {
    id: cronJobId,
    url,
    cron_expression: cronExpression,
