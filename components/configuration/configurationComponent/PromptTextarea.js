      ...
      <div className="w-full">
        ...
        >
          <textarea
            ...
            className={` w-full font-mono text-[12.5px] leading-[1.65] h-full min-h-full max-h-full resize-none bg-transparent border-none caret-base-content outline-none overflow-auto p-2 ${readOnly ? "cursor-not-allowed opacity-70" : ""} ${className} `}
            onBlur={handleBlur}
